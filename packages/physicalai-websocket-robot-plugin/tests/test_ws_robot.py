...
class TestWebSocketRobotConnect:
    def test_connect_success(self, mock_ws):
    ...
    def test_connect_no_features(self):
        with patch("physicalai_websocket_robot_plugin.websocket_robot.ws_connect") as mock_connect:
            ws = MagicMock()
...
class TestWebSocketRobotObservation:
    def test_get_observation(self, robot, mock_ws):
    ...
    def test_get_observation_drains_state_updates(self, robot, mock_ws):
        mock_ws.recv.side_effect = [
    ...
    def test_get_observation_uses_cached_state(self, robot, mock_ws):
    ...
    def test_get_observation_timestamp(self, robot, mock_ws):
        mock_ws.recv.side_effect = [
...
class TestWebSocketRobotActions:
    def test_send_action(self, robot, mock_ws):
        mock_ws.recv.side_effect = [
    ...
    def test_enable_torque(self, robot, mock_ws):
        mock_ws.recv.side_effect = [
    ...
    def test_disable_torque(self, robot, mock_ws):
        mock_ws.recv.side_effect = [
    ...
    def test_send_action_shape_mismatch(self, robot):
